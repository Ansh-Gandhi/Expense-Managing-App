    ...
    <div className="flex flex-col pt-20">
      ...
      <section id="how-it-works" className="py-20">
        <div className="container mx-auto px-4 md:px-6 text-center">
          ...
          <h2 className="gradient-title mt-2 text-3xl md:text-4xl">Spliting expenses has never been easier</h2>
      ...
      <section className="py-20 gradient">
        <div className="container mx-auto px-4 md:px-6 text-center space-y-6">
          <h2 className="text-3xl md:text-4xl font-extrabold text-white tracking-tight">Ready to simplify your expense sharing?</h2>
          ...
          <Button asChild size="lg" className="bg-green-800 hover:bg-green-90">
            <Link href="/dashboard"> Get Started <ArrowRight className="ml-2 h-4 w-4" /></Link>
          </Button>
        </div>
      </section>
