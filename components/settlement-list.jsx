...
const SettlementList = ({ settlements, isGroupSettlement = false, userLookupMap }) => {
                                ...
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <h3 className="font-medium">
                                            {isCurrentUserPayer ? `You paid ${receiver.name}` : isCurrentUserReceiver
                                                ? `${payer.name} paid you`: `${payer.name} paid ${receiver.name}`}
                                        </h3>
